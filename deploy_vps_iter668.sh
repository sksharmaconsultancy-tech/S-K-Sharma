#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 668)
...
#   wget -O deploy668.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy668.sh
...
echo -n "   Server badge is 668 (must say OK): "
grep -q 'APP_ITERATION = "668"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
