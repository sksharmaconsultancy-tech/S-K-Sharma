#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 653)
...
#   wget -O deploy653.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy653.sh
...
echo -n "   Server badge is 653 (must say OK): "
grep -q 'APP_ITERATION = "653"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
...
echo ""
echo "════════════════════════════════════════════════════════════"
echo "  DONE — Iter 653 deployed."
echo "  • NEW (653): Camera button PWA-only; OCR auto-fill for PAN /"
