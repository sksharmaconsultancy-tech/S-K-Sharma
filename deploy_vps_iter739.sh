#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 739)
# Deploys the FULL latest code (includes ALL previous iterations).
#
# ═══════ WHAT'S NEW (Iter 739) — 📜 BRANCH-WISE LICENSES & STATUTORY DOCS ═══════
#
...
echo -n "   Server badge is 739 (must say OK): "
grep -q 'APP_ITERATION = "739"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
