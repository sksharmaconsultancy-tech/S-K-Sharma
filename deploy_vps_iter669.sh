#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 669)
...
#   wget -O deploy669.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy669.sh
...
echo -n "   Server badge is 669 (must say OK): "
grep -q 'APP_ITERATION = "669"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
