#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 671)
...
#   wget -O deploy671.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy671.sh
...
echo -n "   Server badge is 671 (must say OK): "
grep -q 'APP_ITERATION = "671"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
