#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 578 — OTP Email Cleanup)
...
#   wget -O deploy578.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy578.sh
...
echo -n "   Server badge is 578 (must say OK): "
grep -q 'APP_ITERATION = "578"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
