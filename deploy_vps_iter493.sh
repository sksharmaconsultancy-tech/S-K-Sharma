#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 493)
#
# NEW IN 493 — FIRM SWITCH ALWAYS REFRESHES DATA (your report: "After
...
echo -n "   Server Version badge shows 493 (must say OK): "
...
echo ""
echo "✅ Deploy Iter 493 complete! HARD-REFRESH the browser (Ctrl+Shift+R)."
echo ""
echo "   HOW TO VERIFY:"
echo "   1. Footer badge must read 'Server Iter 493'."
