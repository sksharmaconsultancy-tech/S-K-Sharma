#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 490)
#
# NEW IN 490 — DELETE EMPLOYEE (SUPER ADMIN ONLY) — your request:
...
echo -n "   Server Version badge shows 490 (must say OK): "
...
echo ""
echo "✅ Deploy Iter 490 complete! HARD-REFRESH the browser (Ctrl+Shift+R)."
echo ""
echo "   HOW TO VERIFY:"
echo "   1. Footer badge must read 'Server Iter 490'."
echo "   2. DELETE EMPLOYEE: open any employee's Employee Master page as"
echo "      SUPER ADMIN — a red 'Delete Employee (Super Admin only)'"
echo "      button appears below Login Credentials. Sub-admins/company"
echo "      admins never see it and the API rejects them."
