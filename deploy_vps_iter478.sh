#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 478)
...
echo -n "   Server Version badge shows 478 (must say OK): "
grep -q 'APP_ITERATION = "478"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
...
echo ""
echo "✅ Deploy Iter 478 complete! HARD-REFRESH the browser (Ctrl+Shift+R)."
echo ""
echo "   HOW TO VERIFY:"
echo "   1. Portal footer badge must read 'Server Iter 478'."
