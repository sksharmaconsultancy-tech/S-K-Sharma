#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 491)
#
# NEW IN 491 — DELETED EMPLOYEE STILL SHOWED IN COMPLIANCE SALARY (your
...
echo -n "   Server Version badge shows 491 (must say OK): "
...
echo ""
echo "✅ Deploy Iter 491 complete! HARD-REFRESH the browser (Ctrl+Shift+R)."
echo ""
echo "   HOW TO VERIFY:"
echo "   1. Footer badge must read 'Server Iter 491'."
echo "   2. GHOST FIX: open the Compliance Salary run that still showed"
echo "      the deleted (resigned) employee and click REPROCESS — the"
echo "      employee disappears from the sheet."
echo "   3. DELETE EMPLOYEE: red 'Delete Employee (Super Admin only)'"
echo "      button in Employee Master — super admin only."
