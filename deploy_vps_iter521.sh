#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 521)
#
# ═══════════════════ WHAT'S NEW IN 521 ═══════════════════
#
...
#   wget -O deploy521.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy521.sh
...
echo -n "   Server badge is 521 (must say OK): "
grep -q 'APP_ITERATION = "521"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
