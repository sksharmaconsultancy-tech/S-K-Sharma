#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 492)
#
# NEW IN 492 — EMPLOYEE MASTER PDF + SALARY CERTIFICATE (your requests):
...
echo -n "   Server Version badge shows 492 (must say OK): "
...
echo ""
echo "✅ Deploy Iter 492 complete! HARD-REFRESH the browser (Ctrl+Shift+R)."
echo ""
echo "   HOW TO VERIFY:"
echo "   1. Footer badge must read 'Server Iter 492'."
echo "   2. EMPLOYEE MASTER PDF: Download / Print PDF — family details in"
echo "      one line (Name | DOB | Aadhaar), allowances in Salary Details,"
echo "      MM-DD-YYYY dates, full Aadhaar; policy page only for firms"
echo "      with Offline Salary + Biometric enabled."
echo "   3. SALARY CERTIFICATE: pick the period (YYYY-MM) next to the"
echo "      button — locked months print the real processed figures"
echo "      (finalized runs / Old-DB history) with the source shown."
