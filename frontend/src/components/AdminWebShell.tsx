...
export const NAV_SUPER: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { route: "/expense-approvals", label: "Expense Approvals & Payments", icon: "receipt-outline" },
      { route: "/expense-admin", label: "Expense Reports & Categories", icon: "pricetags-outline" },
      { route: "/tour-admin", label: "Tour Management", icon: "airplane-outline" },
      { route: "/analytics", label: "Charts & Analytics", icon: "bar-chart-outline" },
      ...
      { route: "/central-statistical", label: "Central Statistical — Annual Labour", icon: "bar-chart-outline" },
      ...
      { route: "/gate-pass", label: "Gate Pass", icon: "exit-outline" },
      { route: "/probation", label: "Probation / Confirmation", icon: "ribbon-outline" },
      { route: "/accident-register", label: "Accident Register", icon: "medkit-outline" },
      { route: "/weekoff-rules", label: "Alternate Weekoff", icon: "calendar-outline" },
      { route: "/asset-management", label: "Asset Management", icon: "briefcase-outline" },
      { route: "/branch-compliance", label: "Branch P&L / State Rules", icon: "map-outline" },
      { route: "/late-penalty", label: "Late Penalty (Auto)", icon: "alarm-outline" },
      { route: "/ot-management", label: "OT Management", icon: "timer-outline" },
      { route: "/org-hierarchy", label: "Organization Hierarchy", icon: "git-network-outline" },
      { route: "/hr-analytics", label: "HR Analytics & Dashboard", icon: "analytics-outline" },
      { route: "/fnf-calculator", label: "F&F Calculator", icon: "calculator-outline" },
...
const NAV_PERMISSION_MAP: Record<string, string[]> = {
  ...
  "/expense-approvals": ["salary_process:read", "salary_process:write"],
  "/expense-admin": ["salary_process:read", "salary_process:write"],
  "/tour-admin": ["salary_process:read", "salary_process:write"],
  "/analytics": ["salary_process:read", "salary_process:write"],
