          ...
          <>
            <Section title="Provident Fund (PF)" icon="shield-checkmark-outline">
              ...
              <Text style={styles.hint}>
                PF Basic blank/0 → no PF. PF Basic up to the EPF ceiling →
                PF wages = HIGHER of Earned PF Basic / Earned 50% of Gross,
                capped at the ceiling. PF Basic ABOVE the ceiling → adopted
                Higher PF: PF on the full earned PF Basic (no cap); EPS
                stays capped — the balance of the employer share moves to
                Employer EPF.
              </Text>
            </Section>
            ...
            <Section title="ESIC" icon="medkit-outline">
              ...
              <Text style={styles.hint}>
                ESI Wages follow the legacy rule — max(Basic, floor% of
                Gross). Statutory practice rounds ESIC UP to the next rupee.
              </Text>
            </Section>
