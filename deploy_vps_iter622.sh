#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 622)
...
#   wget -O deploy622.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy622.sh
...
echo -n "   Server badge is 622 (must say OK): "
grep -q 'APP_ITERATION = "622"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
