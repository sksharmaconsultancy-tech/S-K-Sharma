#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 577 — OTP Email Branding)
...
#   wget -O deploy577.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy577.sh
...
echo -n "   Server badge is 577 (must say OK): "
grep -q 'APP_ITERATION = "577"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
...
echo "  'Your Smart Payroll Login Code' + compliance-partner signature."
