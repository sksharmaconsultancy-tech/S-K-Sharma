#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 654)
...
#   wget -O deploy654.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy654.sh
...
echo "==> 8b/9 Nginx hardening for BIG salary sheets (Iter 654)..."
...
echo -n "   Server badge is 654 (must say OK): "
grep -q 'APP_ITERATION = "654"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
...
echo ""
echo "════════════════════════════════════════════════════════════"
echo "  DONE — Iter 654 deployed."
echo "  • NEW (654): Salary Lock live-data fix — nginx 50m body/300s"
