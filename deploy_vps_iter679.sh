#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 679)
...
#   wget -O deploy679.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy679.sh
...
echo -n "   Server badge is 679 (must say OK): "
grep -q 'APP_ITERATION = "679"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
