#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 740)
# Deploys the FULL latest code (includes ALL previous iterations).
#
# ═══════ WHAT'S NEW (Iter 740) — 📅 MONTHLY ATTENDANCE DATE CALENDARS ═══════
#
...
echo -n "   Server badge is 740 (must say OK): "
grep -q 'APP_ITERATION = "740"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
