#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 677)
...
#   wget -O deploy677.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy677.sh
...
echo -n "   Server badge is 677 (must say OK): "
grep -q 'APP_ITERATION = "677"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
