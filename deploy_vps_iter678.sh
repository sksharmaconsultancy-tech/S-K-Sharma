#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 678)
...
#   wget -O deploy678.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy678.sh
...
echo -n "   Server badge is 678 (must say OK): "
grep -q 'APP_ITERATION = "678"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
