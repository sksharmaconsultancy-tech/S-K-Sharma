#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 520)
#
# ═══════════════════ WHAT'S NEW IN 520 ═══════════════════
#
...
#   wget -O deploy520.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy520.sh
...
echo -n "   Server badge is 520 (must say OK): "
grep -q 'APP_ITERATION = "520"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
