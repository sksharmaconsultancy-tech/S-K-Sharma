#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 674)
...
#   wget -O deploy674.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy674.sh
...
echo -n "   Server badge is 674 (must say OK): "
grep -q 'APP_ITERATION = "674"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
