#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 479)
#
...
echo -n "   Server Version badge shows 479 (must say OK): "
grep -q 'APP_ITERATION = "479"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
...
echo ""
echo "✅ Deploy Iter 479 complete! HARD-REFRESH the browser (Ctrl+Shift+R)."
echo ""
echo "   HOW TO VERIFY:"
echo "   1. Portal footer badge must read 'Server Iter 479'."
