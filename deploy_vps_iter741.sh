#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 741)
# Deploys the FULL latest code (includes ALL previous iterations).
#
# ══════ WHAT'S NEW (Iter 741) — 3 NEW HR MODULES ══════
#
...
echo -n "   Server badge is 741 (must say OK): "
grep -q 'APP_ITERATION = "741"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
