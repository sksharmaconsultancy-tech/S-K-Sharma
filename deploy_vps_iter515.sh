#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 515)
#
...
#   wget -O deploy515.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy515.sh
...
echo -n "   Server badge is 515 (must say OK): "
grep -q 'APP_ITERATION = "515"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
...
echo ""
echo "   VERIFY: footer badge must read 'Server Iter 515'."
