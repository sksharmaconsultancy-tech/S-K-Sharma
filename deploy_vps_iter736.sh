#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 736)
# Deploys the FULL latest code (includes ALL previous iterations).
#
# ═══════════ WHAT'S NEW (Iter 736) — 🏢 FIRM MASTER के अंदर BRANCHES ═══════════
#
...
echo -n "   Server badge is 736 (must say OK): "
grep -q 'APP_ITERATION = "736"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
