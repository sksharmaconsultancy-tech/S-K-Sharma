#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 725)
# Deploys the FULL latest code (includes ALL previous iterations).
#
# ═══════════ WHAT'S NEW (Iter 725) — 📐 50% GROSS RULE अब ADOPTED PF BASIC (>15,000) पर भी ═══════════
#
...
#   wget -O deploy725.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy725.sh
