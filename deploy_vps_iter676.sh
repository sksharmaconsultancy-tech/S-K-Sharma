#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 676)
...
#   wget -O deploy676.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy676.sh
...
echo -n "   Server badge is 676 (must say OK): "
grep -q 'APP_ITERATION = "676"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
