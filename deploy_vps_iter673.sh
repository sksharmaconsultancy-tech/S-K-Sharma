#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 673)
...
#   wget -O deploy673.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy673.sh
...
echo -n "   Server badge is 673 (must say OK): "
grep -q 'APP_ITERATION = "673"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
