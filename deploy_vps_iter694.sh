#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 694)
...
#   wget -O deploy694.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy694.sh
...
echo -n "   Server badge is 694 (must say OK): "
grep -q 'APP_ITERATION = "694"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
