#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 344)
# Ships (everything since deploy 343):
...
echo ""
echo "✅ Deploy Iter 344 complete! HARD-REFRESH the browser (Ctrl+Shift+R)."
echo "   • SUVIDHI fix: re-run Legacy Import (Employees + Salary) for the"
echo "     firm — structures will match the old database after re-import."
