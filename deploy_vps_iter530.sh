#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 530)
#
...
#   wget -O deploy530.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy530.sh
...
grep -q 'APP_ITERATION = "530"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
