#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 539)
#
...
#
# B. PUNCH-SEQUENCE ATTENDANCE (user rule, Iter 539) — activates when
...
#   wget -O deploy539.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy539.sh
...
grep -q 'APP_ITERATION = "539"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
