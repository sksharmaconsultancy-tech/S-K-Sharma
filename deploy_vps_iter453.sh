#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 453)
...
#
# Iter 452 — DOWNLOAD FILE NAMES = FIRMNAME_MMYYYY:
#   • ECR: KANKANIENTERPRISES_072026.txt — uploadable to EPFO directly.
#   • ESIC: ESIC_MC_FIRMNAME_MMYYYY.xls follows the same pattern.
#
...
echo -n "   FIRMNAME_MMYYYY filenames / Iter 452 (must say OK): "
grep -q '_ecr_fname' $APP_DIR/backend/routes/challans.py && echo "OK" || echo "MISSING!"
...
echo ""
echo "✅ Deploy Iter 453 complete! HARD-REFRESH the browser (Ctrl+Shift+R)."
echo ""
echo "   HOW TO VERIFY:"
...
echo "   2. DOWNLOAD ECR: file saves as FIRMNAME_MMYYYY.txt (e.g."
echo "      KANKANIENTERPRISES_072026.txt) — upload it to EPFO directly."
