#!/bin/bash
# S.K. Sharma & Co. — VPS deploy script (Iter 552)
#
...
#
# B. TAN + PAN QUICK ENTRY (Iter 552, enables your workflow):
...
#   wget -O deploy552.sh "https://emplo-connect-1.preview.emergentagent.com/api/temp-code-bundle?token=sks-deploy-7391&kind=script"
#   bash deploy552.sh
...
echo -n "   Server badge is 552 (must say OK): "
grep -q 'APP_ITERATION = "552"' $APP_DIR/backend/server.py && echo "OK" || echo "MISSING!"
